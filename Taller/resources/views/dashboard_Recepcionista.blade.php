...
<body>
  <!-- Panel lateral -->
  <div class="sidebar">
    <button onclick="showSection('Calendario')">Calendario de Citas</button><br>
    <button onclick="showSection('FiltrarCita')">Filtrar Cita</button><br>
  </div>
  ...
  <div class="content">
    ...
    <div id="Calendario" class="section2">
    ...
    <div id="FiltrarCita" class="section2">
      <h2>Filtrar Cita</h2>

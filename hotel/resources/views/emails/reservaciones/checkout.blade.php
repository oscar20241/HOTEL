...
<body>
    <div class="container">
        <h1>¡Gracias por tu estancia!</h1>
        <p>Hola {{ $reservacion->user->name }},</p>
        <p>
            Hemos completado el check-out de tu reservación <strong>{{ $reservacion->codigo_reserva }}</strong>.
            Te compartimos el resumen final de tu visita.
        </p>
        ...
        <div class="section">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="value">{{ optional($reservacion->fecha_checkout)->format('d/m/Y H:i') ?? 'Registrado' }}</td>
                </tr>
            </table>
        </div>
        ...
        <p>Esperamos volver a verte pronto. Si tienes comentarios sobre tu estancia, no dudes en responder a este correo.</p>

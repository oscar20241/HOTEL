...
@section('content')
    <section class="bg-gradient-to-br from-indigo-900 via-slate-900 to-slate-950 text-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <p class="mt-3 text-sm text-white/70 max-w-2xl">Actualiza tus datos personales y mantén tu información de seguridad al día para que podamos brindarte una experiencia impecable en Hotel Aurora.</p>
        </div>
    </section>

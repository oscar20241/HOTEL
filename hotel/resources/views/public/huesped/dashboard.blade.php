            ...
            <div class="grid lg:grid-cols-[1.1fr_0.9fr] gap-12 items-start">
                <div class="space-y-6">
                    ...
                    <p class="text-base sm:text-lg text-slate-200/90 max-w-2xl">
                        Planea tu próxima escapada, revisa tus reservaciones y mantén tus datos actualizados desde esta nueva experiencia pensada para huéspedes. Todo lo que necesitas para disfrutar en HOTEL PASA EL EXTRA INN está aquí.
                    </p>

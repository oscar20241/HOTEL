...
<body class="bg-slate-50 text-slate-700">
                ...
                <div class="flex items-center gap-4">
                    @auth
                        <div class="hidden md:flex items-center gap-6 text-sm font-semibold text-slate-500">
                            ...
                            <a href="{{ route('home') }}#habitaciones" class="inline-flex items-center gap-1 text-indigo-600 hover:text-indigo-700 transition">
    ...
    <main>
        @if (session('success'))
            <div class="bg-emerald-500/10 border border-emerald-500/40 text-emerald-700 rounded-xl mx-4 sm:mx-auto sm:max-w-3xl mt-6 px-4 py-3">
                <p class="text-sm font-medium">{{ session('success') }}</p>
            </div>
        @endif

        @if (session('error'))
            <div class="bg-rose-500/10 border border-rose-500/40 text-rose-700 rounded-xl mx-4 sm:mx-auto sm:max-w-3xl mt-6 px-4 py-3">
